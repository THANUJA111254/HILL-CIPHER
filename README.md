...
int main() {
    char plainText[100], cipherText[100] = "", temp[100];
    int key[SIZE][SIZE], len, idx = 0;
...
## OUTPUT
<img width="780" height="360" alt="image" src="https://github.com/user-attachments/assets/e5f852ad-8a22-4d7c-a2b1-6bda8577dc24" />
